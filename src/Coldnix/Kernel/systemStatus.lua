...
local memoryText=terminal.padText("|Memory: "..(System.utility.floatCut(computer.freeMemory()/1024,3)).."kb/"..(computer.totalMemory()/1024).."kb".." "..x.." "..y.." CPU Time: "..System.utility.floatCut((computer.ElapseT/5)*100,3).."%",x-1).."|"
