...
BOOTGPUPROXY.set(1,1,terminal.padText("|"..config.configList.OSNAME.." | V"..config.configList.OSVERSION.."    CPU Time: "..System.utility.floatCut((computer.ElapseT/5)*100,3).."%",x-1).."|")
